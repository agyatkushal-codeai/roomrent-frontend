...
import { MapPin, DollarSign, Phone, List, Loader2 } from 'lucide-react';
...
const EditRoom = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://localhost:5000/api/rooms/${id}`, dataToSubmit, {
        headers: {
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      >
        <h1 className="text-3xl font-bold mb-8">Edit Your Room</h1>
